...
func (e *extension) Call(fnName string, arg ...interface{}) (interface{}, error) {
...
func (e *extension) MustCall(fnName string, arg ...interface{}) interface{} {
	var ret interface{}
	var err error
	if ret, err = e.Call(fnName, arg...); err != nil {
		panic(err.Error())
	}
	return ret
}

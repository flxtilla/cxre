...
import (
	...
	"github.com/thrisp/flotilla/asset/pack"
)
...
func parseArgs() *pack.Config {
	...
	flag.StringVar(&c.StripPrefix, "stripPrefix", c.StripPrefix, "Optional path prefix to strip off asset names.")
	flag.StringVar(&c.Package, "pkg", c.Package, "Package name to use in the generated code.")
	flag.StringVar(&c.FSName, "fsName", c.FSName, "The variable name of the generated AssetFS.")
	flag.StringVar(&c.FSPrefix, "fsPrefix", c.FSPrefix, "A path prefix for the AssetFS.")
	...
	c.Input = make([]pack.InputConfig, flag.NArg())
	for i := range c.Input {
...
func parseInput(path string) pack.InputConfig {
	if strings.HasSuffix(path, "/...") {
		return pack.InputConfig{

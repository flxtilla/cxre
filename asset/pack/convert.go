...
func Translate(c *Config) error {
	...
	for _, input := range c.Input {
		err = findFiles(input.Path, c.StripPrefix, input.Recursive, &toc, c.Ignore, knownFuncs, visitedPaths)
		if err != nil {
			return err
		}
	}
	...
	if _, err = fmt.Fprint(bfd, "// Code generated by flotilla/asset/pack.\n"); err != nil {
		return err
	}
	...
	if err := writeTOC(bfd, c, toc); err != nil {
		return err
	}
